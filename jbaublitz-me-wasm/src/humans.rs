...
<div class="body">
    <p>I work on a volunteer basis as part of <a href="https://www.resilientcoders.org">Resilient Coders</a>. If you think diversity matters, click on the link and consider supporting an organization that's trying to make that happen in a real and actionable way!</p>
</div>
"#;
